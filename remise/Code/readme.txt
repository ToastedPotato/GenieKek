Section 0: Démarrage de l'application
    ...
    Exécution à partir d'un IDE:
        ...
        Vous pouvez simplement ouvrir cette classe (située dans le projet 
        GenieK) dans votre IDE et cliquer sur le bouton "exécuter" (le chevron 
        vert dans la barre de tâches de l'IDE).
